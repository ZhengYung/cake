    ...
    <nav class="topNav navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
          <ul class="navbar-nav">
            <li class="nav-item">
              <RouterLink to="/about" :class="[$route.name === 'about' ? 'atcive' : '', 'nav-link']" aria-current="page">品牌故事
              </RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink to="/news" :class="[$route.name === 'news' ? 'atcive' : '', 'nav-link']">最新消息</RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink to="/products"
                :class="[$route.name === 'products' || $route.name === 'product-detail' ? 'atcive' : '', 'nav-link']">產品介紹
              </RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink to="/faq" :class="[$route.name === 'faq' ? 'atcive' : '', 'nav-link']">購物須知</RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink to="/contact" :class="[$route.name === 'contact' ? 'atcive' : '', 'nav-link']">聯絡我們</RouterLink>
            </li>
          </ul>
        </div>
      </div>
