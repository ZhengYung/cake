...
const submitForm = () => {
    ...
    axios.post('/productFlavor', formData)
        .then(res => {
        ...
        <v-form @submit.prevent="submitForm" v-model="form">
            <v-row>
                ...
                <v-col cols="8">
                    ...
                    <v-text-field type="number" min="0" v-model:model-value="price" :rules="[rules.required]"
                        label="價格" prepend-icon="fa-solid fa-minus" append-icon="fa-solid fa-plus"
                        ...
                        <v-col cols="6" sm="4" md="" v-for="(item, index) in selectPicture" :key="item.id">
                            <div class="select-picture" >
                                ...
                                <input class="fileSelector" type="file"
                                    accept="image/jpg, image/jpeg, image/png, image/gif" @click="currentSelectPicture=item"  @change="selectFile">
                            </div>
                        </v-col>
                    </v-row>
